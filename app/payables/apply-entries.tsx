...
import { vendorLedgerEntriesRequest, applyEntriesRequest, unapplyEntryRequest } from '@/app/actions/payables';
import type { VendorLedgerEntryView } from '@/lib/types';

export function ApplyEntriesButton({ entry, className = 'btn sm ghost' }: { entry: VendorLedgerEntryView; className?: string }) {
  const [open, setOpen] = useState(false);
  const [rows, setRows] = useState<VendorLedgerEntryView[] | null>(null);
